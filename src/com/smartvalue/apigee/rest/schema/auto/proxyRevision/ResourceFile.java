...
public class ResourceFile {
    ...
    public ResourceFile withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ResourceFile withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public ResourceFile withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ResourceFile.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ResourceFile) == false) {
            return false;
        }
        ResourceFile rhs = ((ResourceFile) other);
