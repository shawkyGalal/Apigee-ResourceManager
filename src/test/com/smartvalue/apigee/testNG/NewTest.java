	...
	@Test
	 ...
	 @Test
	  public void testImportAll() throws Exception {
		...
		LoadResults sharedflowsFaults =  ((SharedFlowServices) destMngServer.getSharedFlowServices()).withDeployUponUpload(deployUponImport).importAll(sourceFolderName +"\\sharedflows") ;
		LoadResults proxiesFaults =  ((ProxyServices) destMngServer.getProxyServices()).withDeployUponUpload(deployUponImport).importAll(sourceFolderName +"\\proxies") ;
